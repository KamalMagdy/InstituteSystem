...
class DocumentsController < ApplicationController
 before_action :google_drive_login, :only => [:list_google_docs]

 GOOGLE_CLIENT_ID = "77887582508-to3vulnhtgk7eaq53105fto2hhn2032g.apps.googleusercontent.com"
 GOOGLE_CLIENT_SECRET = "iMD6-KxnZWlpcijlX3cBdO0-"
